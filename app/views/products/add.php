...
<div class="grid grid-cols-5 h-screen max-h-screen ">
    ...
    <div class="col-span-4 overflow-y-auto px-4 bg-gray-100 pt-10">
        <div class="max-w-lg mx-auto shadow-lg bg-white rounded-md px-6 py-4 overflow-hidden">
            ...
            <h2 class="text-center text-2xl font-semibold text-gray-700 mb-2">Add Product</h2>

            <form action="<?= URLROOT?>/products/add" method="post" enctype="multipart/form-data">
                ...
                <div class="pt-4">
                    ...
                    <textarea name="description" id="" cols="20" rows="3" class="block w-full mt-1 text-sm  border  rounded-md  focus:ring-0"></textarea>
                    
                </div>
                <div class="pt-4 grid grid-cols-3 gap-2">
                    <div>
                        <label for="buyPrice" class="text-sm text-gray-600 block ">Buy Price</label>
                        <input type="number" name="buyPrice" placeholder="Buy Price" class="block w-full mt-1 text-sm  border  rounded-md  focus:ring-0" value="<?=$data['name']?>">
                        
                    </div>
                    <div>
                        <label for="offrePrice" class="text-sm text-gray-600 block ">Offre Price</label>
                        <input type="number" name="offrePrice" placeholder="Offre Price" class="block w-full mt-1 text-sm  border  rounded-md  focus:ring-0" value="">
                       
                    </div>
                    <div>
                        <label for="" class="text-sm text-gray-600 block ">Final Price</label>
                        <input type="number" name="finalPrice" placeholder="Final Price" class="block w-full mt-1 text-sm  border  rounded-md  focus:ring-0" value="">
                ...
                <div class="pt-4 grid grid-cols-2 gap-2">
                    <div>
                        ...
                        <input type="number" name="quantity" placeholder="Quantity" class="block w-full mt-1 text-sm  border  rounded-md  focus:ring-0" value="">
