...
<div class="bg-gray-800 py-4">
    <div class="containner flex items-center justify-between">
        <p class="text-white text-sm font-medium font-roboto"> Electro Maroc &copy; Copyright <?php echo date('Y')?></p>
        <img src="<?=URLROOT?>/public/img/payments.png" alt="" class="h-6 w-30">
    </div>
</div>
